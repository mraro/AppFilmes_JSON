package domain.aro.appfilmes_json;

/**
 * Created by alessandro.roliveir4 on 13/04/2018.
 */

public class Api {


    private static final String ROOT_URL = "http://10.23.49.32/HeroApi/v1/Api.php?apicall=";
